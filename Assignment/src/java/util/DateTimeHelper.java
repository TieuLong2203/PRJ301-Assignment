...
public class DateTimeHelper {
    ...
    public static ArrayList<java.sql.Date> getDateInRange(java.sql.Date startSQLDate, java.sql.Date endSQLDate) {
        ArrayList<java.sql.Date> sqlDates = new ArrayList<>();

        // Create a Calendar instance to iterate through the date range
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(startSQLDate);

        // Iterate through the date range and add to the list
        while (!calendar.getTime().after(endSQLDate)) {
